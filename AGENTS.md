...
cd ## Project Overview
insights-ccx-messaging is a Python-based framework for the Red Hat Insights ecosystem, built on top of insights-core-messaging. It provides a plugin-based architecture for consuming, processing, and publishing messages in different technonolgies like Kafka, S3...
...
5. Watchers monitors service events. Example events: downloaded archive, received message, processed message, sent message...
...
5. In the meantime, different watchers are monitoring the events of the service, for example, exposing Prometheus metrics.
